...
describe('api.digitransit.fi', function() {
  ...
  testProxying('api.digitransit.fi','/routing-data/v1/router-hsl.zip','opentripplanner-data-con-hsl:8080');
  testProxying('api.digitransit.fi','/routing-data/v1/router-waltti.zip','opentripplanner-data-con-waltti:8080');
  testProxying('api.digitransit.fi','/routing-data/v1/router-finland.zip','opentripplanner-data-con-finland:8080');
});
